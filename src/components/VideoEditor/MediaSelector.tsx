...
interface MediaSelectorProps {
  onSelectBackground: (type: "image" | "video" | "color", src?: string, color?: string) => void;
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap">
          ...
          <button 
            ...
            onClick={() => backgroundImage ? handleBackgroundTypeChange("image") : imageInputRef.current?.click()}
          >
            Image
          </button>
          <button 
            className={`mr-2 mb-2 px-3 py-2 rounded text-white border-none cursor-pointer ${backgroundVideo ? 'bg-blue-700' : 'bg-blue-500'}`}
            onClick={() => backgroundVideo ? handleBackgroundTypeChange("video") : videoInputRef.current?.click()}
          >
            Video
          </button>
        </div>
        ...
        <div className="mt-2.5">
          <label className="block mb-1.5 font-semibold">Background Color:</label>
          <input 
            type="color" 
